...
SELECT facid, name, membercost, monthlymaintenance FROM Facilities WHERE membercost > 0 AND membercost < 20 / 100 * monthlymaintenance
...
SELECT b.facid, COUNT(memid) AS mem_usage, name
...
SELECT b.facid, COUNT(memid) AS SELECT b.months, COUNT( memid ) AS mem_usage
